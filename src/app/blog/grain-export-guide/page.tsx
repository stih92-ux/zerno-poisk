      ...
      <main className="flex-grow">
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none text-[#1c1c1c] dark:text-gray-300">
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness"><strong>Железнодорожный транспорт:</strong> самый дешёвый вариант для дальних расстояний, поезда везут в вагонах (обычно 60-70 тонн в вагоне)</li>
              <li className="text-base leading-relativness"><strong>Автомобильный транспорт:</strong> быстрее, но дороже, используется для близких расстояний</li>
              <li className="text-base leading-relativness"><strong>Комбинированная доставка:</strong> сначала по железной дороге до близлежащего города, затем на грузовике до порта</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness"><strong>Новороссийск (Черноморский порт):</strong> крупнейший, пропускная способность 8-10 млн тонн/год</li>
              <li className="text-base leading-relativness"><strong>Кавказ (Темрюк):</strong> современные терминалы, вместимость 3-4 млн тонн</li>
              <li className="text-base leading-relativness"><strong>Тамань (Анапа):</strong> быстрорастущие мощности, 5-7 млн тонн</li>
              <li className="text-base leading-relativness"><strong>Ростов-на-Дону (порт на Дону):</strong> речные суда, мощность 2-3 млн тонн</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness"><strong>Хранение в амбарах:</strong> 0.5-1.0 ₽/т в день</li>
              <li className="text-base leading-relativness"><strong>Хранение в силосах:</strong> 0.2-0.5 ₽/т в день (более экономично)</li>
            </ul>
            <p className="text-base leading-relativness mb-6">
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness">Декларацию товаров (ДТ-Э)</li>
              <li className="text-base leading-relativness">Комерческие документы (контракт, счёт-фактуру)</li>
              <li className="text-base leading-relativness">Упаковочный лист (если требуется)</li>
              <li className="text-base leading-relativness">Сертификаты и декларации качества</li>
              <li className="text-base leading-relativness">Доверенность от вашей компании</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness"><strong>Экспортная пошлина:</strong> на начало 2026 года для пшеницы 40-60 ₽/т (зависит от цены)</li>
              <li className="text-base leading-relativness"><strong>НДС:</strong> 0% (экспорт освобождён от НДС)</li>
              <li className="text-base leading-relativness"><strong>Таможенный сбор:</strong> зависит от таможни, обычно 750 ₽ - 1500 ₽ за декларацию</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness">Брокер подаёт декларацию в электронную систему таможни</li>
              <li className="text-base leading-relativness">Таможня проводит документарную проверку</li>
              <li className="text-base leading-relativness">Возможна физическая проверка груза (выборочно)</li>
              <li className="text-base leading-relativness">Таможня выдаёт разрешение на вывоз (таможенное свидетельство)</li>
              <li className="text-base leading-relativness">Груз загружается на корабль</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness"><strong>FOB (Free on Board):</strong> покупатель платит после загрузки, весь риск переходит на него</li>
              <li className="text-base leading-relativness"><strong>CIF (Cost, Insurance and Freight):</strong> вы платите за доставку, покупатель платит после получения документов</li>
              <li className="text-base leading-relativness"><strong>L/C (Letter of Credit):</strong> безопасный способ с участием банков</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness"><strong>Аккредитив:</strong> самый безопасный способ через банки</li>
              <li className="text-base leading-relativness"><strong>Банковский перевод (SWIFT):</strong> стандартный способ</li>
              <li className="text-base leading-relativness"><strong>Чек:</strong> реже используется в международной торговле</li>
            </ul>
            ...
            <ul className="pl-6 list-disc space-y-2 mb-6">
              <li className="text-base leading-relativness">Правильно зарегистрируйте компанию и получите все необходимые лицензии (ФГИС)</li>
              <li className="text-base leading-relativness">Найдите надёжного покупателя через <Link href="/farmers" className="text-[#2d7a2d] hover:underline">ЗерноПоиск</Link> или брокеров</li>
              <li className="text-base leading-relativness">Заключите детальный контракт, охватывающий все аспекты сделки</li>
              <li className="text-base leading-relativness">Соберите все необходимые документы (фитосанитарный сертификат, декларацию соответствия, счёт-фактуру)</li>
              <li className="text-base leading-relativness">Организуйте логистику до портового терминала</li>
              <li className="text-base leading-relativness">Нанимите опытного таможенного брокера для таможенного оформления</li>
              <li className="text-base leading-relativness">Убедитесь в безопасности условий платежа</li>
            </ul>
            <p className="text-base leading-relativness">
